...
const descriptors: Record<ReleaseChannel, ReleaseChannelDescriptor> = {
  ...
  betas: {
    appId: "io.posicube.robi-design-studio.betas",
    baseVersionField: "baseVersion",
    channel: "betas",
    counterField: "releaseNumber",
    displayLabel: "Betas",
  ...
  prerelease: {
    appId: "io.posicube.robi-design-studio.prerelease",
    baseVersionField: "baseVersion",
    channel: "prerelease",
    counterField: "releaseNumber",
  ...
  preview: {
    appId: "io.posicube.robi-design-studio.preview",
    baseVersionField: "baseVersion",
    channel: "preview",
    counterField: "releaseNumber",
