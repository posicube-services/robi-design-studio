...
export const zhCN: Dict = {
  ...
  "homeHero.chip.a2uiScreenDesc": "基于固定目录的规范驱动界面",
  "homeHero.chip.a2uiShadcnScreenDesc": "相同的 A2UI 契约，由设计系统驱动样式",
  "homeHero.chip.nextProjectDesc": "带 SSR 与文件路由的多文件 Next 应用",
  "homeHero.chip.nextProjectShadcnDesc": "带 SSR 与文件路由的多文件 Next 应用",
  "homeHero.chip.reactProjectDesc": "可作为静态文件部署的 Vite + React SPA",
  "homeHero.chip.reactProjectShadcnDesc": "可作为静态文件部署的 Vite + React SPA",
