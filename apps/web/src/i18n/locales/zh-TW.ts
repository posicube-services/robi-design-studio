...
export const zhTW: Dict = {
  ...
  "homeHero.chip.a2uiScreenDesc": "以固定目錄為基礎的規格驅動畫面",
  "homeHero.chip.a2uiShadcnScreenDesc": "相同的 A2UI 契約，由設計系統驅動樣式",
  "homeHero.chip.nextProjectDesc": "具 SSR 與檔案路由的多檔案 Next 應用",
  "homeHero.chip.nextProjectShadcnDesc": "具 SSR 與檔案路由的多檔案 Next 應用",
  "homeHero.chip.reactProjectDesc": "可作為靜態檔案部署的 Vite + React SPA",
  "homeHero.chip.reactProjectShadcnDesc": "可作為靜態檔案部署的 Vite + React SPA",
